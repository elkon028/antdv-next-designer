        ...
        <div class="designer-config-panel">
            <div class="panel-container">
                ...
                <div class="section-header">
                    <span class="section-title">多语言设置 <a href="https://view.form-create.com/form-locale"
                                                              target="_blank"><i class="fc-icon icon-question"></i></a></span>
                </div>
                ...
                <div class="section-header">
                    <span class="section-title">功能设置 <a href="https://view.form-create.com/hidden-item"
                                                            target="_blank"><i
                        class="fc-icon icon-question"></i></a></span>
                </div>
                                ...
                                <div class="setting-item">
                                    <span class="item-title">{{ child.label }}
                                        <template v-if="child.img">
                                            <a-popover placement="top" :overlayStyle="{width: '350px'}" trigger="hover">
                                                <i class="fc-icon icon-question"></i>
                                                <template #content>
                                                    <a href="https://view.form-create.com/hidden-module"
                                                       target="_blank"><img
                ...
                <!-- 菜单设置 -->
                <div class="section-header">
                    <span class="section-title">菜单设置 <a href="https://view.form-create.com/hidden-item"
                                                            target="_blank"><i
                        class="fc-icon icon-question"></i></a></span>
                </div>
                <div>
                ...
                <div class="section-header">
                    <span class="section-title">操作权限 <a href="https://view.form-create.com/component-permission"
                                                            target="_blank"><i
                        class="fc-icon icon-question"></i></a></span>
                </div>
                    ...
                    <template v-for="(com, idx) in componentPermission">
                        <div class="permission-item">
                            ...
                            <div class="permission-item-checkbox">
                                <a-checkbox-group class="template-grid" v-model:value="com.permission">
...
<script setup>
    ${this.activeLocale === 'zh-cn' ? '' : `import ${this.activeLocale} from '@form-create/antdv-next-designer/locale/${this.activeLocale}.js`}
