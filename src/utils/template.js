...
export function htmlTemplate(json, options) {
    ...
    <head>
        <meta charset="UTF-8">
        <!-- Import style -->
        <link rel="stylesheet" href="https://unpkg.com/antdv-next@4/dist/reset.css"/>
        <!-- Import Vue 3 -->
        ...
        <!-- Import antdv-next -->
        <script src="https://unpkg.com/antdv-next@1.3.7/dist/antd.js"></script>
        <!-- Import formCreate -->
        <script src="https://unpkg.com/@form-create/antdv-next@3"></script>
        <script src="https://unpkg.com/@form-create/antdv-next-designer@3"></script>
    </head>
    <body>
        <div id="app">
